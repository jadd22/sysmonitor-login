...
QT_MOC_LITERAL(12, 248, 24) // "on_pushButton_11_clicked"
    ...
    "demoapp\0on_pushButton_2_clicked\0\0"
...
void demoapp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        demoapp *_t = static_cast<demoapp *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject demoapp::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_demoapp.data,
      qt_meta_data_demoapp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
